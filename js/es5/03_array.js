...
books.unshift({title: "이것이 자바다.", price: 40000, author: "김상형", order: 5});
console.log(books);
//4. 맨 앞쪽에 추가한것을 지우시오,
books.shift();
console.log(books);
// 5. 맨 뒷쪽에 추가하시오. (힌트: push)
books.push({title: "이것이 자바다.", price: 40000, author: "김상형", order: 5});
console.log(books);
// 6. 맨 뒤쪽에 추가한것을 지우시오,
...
books.splice(2, 0, {title: "이것이 자바다.", price: 40000, author: "김상형", order: 5});
console.log(books);
// 8. 방금 삽입한거를 삭제하시오.
books.splice(2,1);
console.log(books);
...
books.forEach( item =>
  sum += item.price // sum = sum + item.price
);
